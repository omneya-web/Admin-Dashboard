...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="/" class="brand-link">
      <img src="/dist/img/logo-puris.png"  class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">Scan Ray</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="/primaryexamination" class="nav-link">
              <i class="fas fa-circle nav-icon"></i>
              <p>Primary Examination</p>
            </a>
          </li>
...
<?php /**PATH C:\xampp\htdocs\Admin-Dashboard\Admin_DB\resources\views/layouts/includes.blade.php ENDPATH**/ ?>